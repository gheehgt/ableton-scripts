...
# Note and CC Mappings for the A01 script (APC emulation) are defined in this file
...
BUTTONCHANNEL = 5 #Channel assignment for all mapped buttons/pads; valid range is 0 to 15 ; 0=1, 1=2 etc.
